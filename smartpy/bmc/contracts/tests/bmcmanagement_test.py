...
def test():
    ...
    sc.verify_equal(get_routes, sp.map({0: sp.record(dst=sp.string("btp://0x7.icon/cxff8a87fde8971a1d10d93dfed3416b0a6258dest"), next=sp.string("btp://0x7.icon/cxff8a87fde8971a1d10d93dfed3416b0a6258d67b"))}))


    # test case 8: add_link function
    # add_link by random address should fail
    bmcManagement_contract.add_link("btp://0x7.icon/cxff8a87fde8971a1d10d93dfed3416b0a6258d67b").run(sender=bob, valid=False, exception="Unauthorized")
    # should work
    ...
    bmcManagement_contract.remove_link("btp://0x7.icon/cxff8a87fde8971a1d10d93dfed3416b0a6258dead").run(sender=bob, valid=False, exception="Unauthorized")
    # remove_link should throw error when removing non-existing link
    bmcManagement_contract.remove_link("btp://0x7.icon/cxff8a87fde8971a1d10d93dfed3416b0a6258dead").run(sender=creator, valid=False, exception="NotExistsLink")
    # should work
    bmcManagement_contract.add_link("btp://0x7.icon/cxff8a87fde8971a1d10d93dfed3416b0a6258dead").run(sender=creator)
    bmcManagement_contract.remove_link("btp://0x7.icon/cxff8a87fde8971a1d10d93dfed3416b0a6258dead").run(sender=creator)
    ...
    # only bmc periphery address can run other users should get error
    bmcManagement_contract.update_link_tx_seq(sp.record(prev=next_link1, serialized_msg=sp.bytes("0x64"))).run(sender=creator,  valid=False, exception="Unauthorized")
    # working
    bmcManagement_contract.update_link_tx_seq(sp.record(prev=next_link1, serialized_msg=sp.bytes("0x64"))).run(sender=bmc_periphery_address)
    ...
    sc.verify_equal(bmcManagement_contract.resolve_route(sp.string('0x7.icon')), sp.pair('btp://0x7.icon/cxff8a87fde8971a1d10d93dfed3416b0a6258d67b', 'btp://0x7.icon/cxff8a87fde8971a1d10d93dfed3416b0a6258dest'))


    # test case setters

    # set_helper_address
    bmcManagement_contract.set_helper_address(sp.address("KT1EXYXNGdbh4uvdKc8hh7ETQXCXPzhelper")).run(sender=jack, valid=False, exception="Unauthorized")  
    bmcManagement_contract.set_helper_address(sp.address("KT1EXYXNGdbh4uvdKc8hh7ETQXCXPzhelper")).run(sender=creator)
    sc.verify(bmcManagement_contract.data.helper == sp.address("KT1EXYXNGdbh4uvdKc8hh7ETQXCXPzhelper"))

    # set_bmc_periphery 
    bmcManagement_contract.set_bmc_periphery(sp.address("KT1EXYXNGdbh4uvdKc8hh7ETQXCperiphery")).run(sender=jack, valid=False, exception="Unauthorized")  
    bmcManagement_contract.set_bmc_periphery(sp.address("KT1EXYXNGdbh4uvdKc8hh7ETQXCperiphery")).run(sender=creator)
    sc.verify(bmcManagement_contract.data.bmc_periphery == sp.some(sp.address("KT1EXYXNGdbh4uvdKc8hh7ETQXCperiphery")))
